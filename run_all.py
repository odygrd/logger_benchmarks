...
benchmarks = [benchmark_quill_no_dual_mode_unbounded, benchmark_quill_dual_mode_unbounded, benchmark_quill_dual_mode_bounded, benchmark_platformlab, benchmark_ms_binlog, benchmark_spdlog, benchmark_g3log, benchmark_iyengar_nanolog, benchmark_reckless]
