...
QUILL_NODISCARD QUILL_ATTRIBUTE_HOT inline std::byte* decode_args(std::byte* in,
                                                                  std::vector<fmt::basic_format_arg<fmt::format_context>>&,
                                                                  std::byte**)
{
  return in;
}
...
template <size_t CstringIdx, typename Arg, typename... Args>
QUILL_NODISCARD_ALWAYS_INLINE_HOT constexpr std::byte* encode_args(size_t* c_string_sizes,
                                                                   std::byte* out,
                                                                   Arg&& arg,
                                                                   Args&&... args)
{
 ...
 * Format function
 */
using FormatToFn = std::byte* (*)(fmt::string_view format,
                                  std::byte* data,
                                  fmt::memory_buffer& out,
                                  std::vector<fmt::basic_format_arg<fmt::format_context>>& args);

template <typename... Args>
QUILL_NODISCARD QUILL_ATTRIBUTE_HOT std::byte* format_to(fmt::string_view format,
                                                         std::byte* data,
                                                         fmt::memory_buffer& out,
                                                         std::vector<fmt::basic_format_arg<fmt::format_context>>& args)
{
