...
private:
  ...
  QUILL_ATTRIBUTE_HOT uint32_t _read_queue_messages_and_decode(QueueT& queue, ThreadContext* thread_context, uint64_t ts_now)
  {
  ...
  /***/
  QUILL_ATTRIBUTE_HOT bool _get_transit_event_from_queue(std::byte*& read_pos, ThreadContext* thread_context, uint64_t ts_now)
  {
