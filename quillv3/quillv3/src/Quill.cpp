...
/***/
std::shared_ptr<Handler> file_handler(fs::path const& filename,
                                      FileHandlerConfig const& config, /* = FileHandlerConfig{} */
...
/***/
std::shared_ptr<Handler> json_file_handler(fs::path const& filename,
                                           JsonFileHandlerConfig const& config, /* = JsonFileHandlerConfig{} */
                                           FileEventNotifier file_event_notifier /* = FileEventNotifier{} */)
{
