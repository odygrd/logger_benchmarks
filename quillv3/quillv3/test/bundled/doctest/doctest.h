...
// if registering is not disabled
  ...
  #define DOCTEST_REGISTER_FUNCTION(global_prefix, f, decorators)                                  \
    global_prefix DOCTEST_GLOBAL_NO_WARNINGS(                                                      \
      ...
      doctest::detail::regTest(                                                                    \
        doctest::detail::TestCase(f, __FILE__, __LINE__, doctest_detail_test_suite_ns::getCurrentTestSuite()) * decorators))
  ...
  #define DOCTEST_TEST_CASE_TEMPLATE_DEFINE_IMPL(dec, T, iter, func)                                            \
    ...
    {                                                                                                           \
      ...
      {                                                                                                         \
        doctest::detail::regTest(doctest::detail::TestCase(                                                     \
  ...
  #define DOCTEST_TO_LVALUE(...) __VA_ARGS__ // Not removed to keep backwards compatibility.
    ...
    #define DOCTEST_ASSERT_IMPLEMENT_2(assert_type, ...)                                                                                                       \
      ...
      DOCTEST_WRAP_IN_TRY(DOCTEST_RB.setResult(                                                                                                                \
        doctest::detail::ExpressionDecomposer(doctest::assertType::assert_type) << __VA_ARGS__)) /* NOLINTNEXTLINE(clang-analyzer-cplusplus.NewDeleteLeaks) */ \
