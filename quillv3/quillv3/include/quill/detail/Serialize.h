...
QUILL_ATTRIBUTE_HOT inline void decode_arg(std::byte*& buffer,
                                           ...
                                           uint32_t& destruct_arg_index) noexcept
{
  using ArgType = remove_cvref_t<Arg>;
...
QUILL_NODISCARD QUILL_ATTRIBUTE_HOT inline size_t calculate_arg_size_and_string_length(
  QUILL_MAYBE_UNUSED size_t* c_style_string_lengths,
 ...
 */
template <typename T>
QUILL_ATTRIBUTE_HOT inline void encode_arg(std::byte*& buffer,
                                           size_t const* c_style_string_lengths,
                                           uint32_t& c_style_string_lengths_index,
                                           T const& arg) noexcept
{
  if constexpr (is_char_array_type<T>())
 ...
 */
template <typename... Args>
QUILL_ATTRIBUTE_HOT inline void encode(std::byte*& buffer,
                                       QUILL_MAYBE_UNUSED size_t const* c_style_string_lengths,
                                       Args const&... args) noexcept
{
  QUILL_MAYBE_UNUSED uint32_t c_style_string_lengths_index{0};
 ...
 * Format function
 */
using FormatToFn = bool (*)(std::string_view format,
                            std::byte*& data,
...
using PrintfFormatToFn = bool (*)(std::string_view format,
                                  std::byte*& data,
                                  transit_event_fmt_buffer_t& out,
