...
public:
   ...
   * Constructor
   */
  ThreadContext(QueueType queue_type,
  ...
  QUILL_NODISCARD_ALWAYS_INLINE_HOT std::conditional_t<(queue_type == QueueType::UnboundedBlocking) || (queue_type == QueueType::UnboundedNoMaxLimit) || (queue_type == QueueType::UnboundedDropping), UnboundedQueue, BoundedQueue>& spsc_queue() noexcept
  {
