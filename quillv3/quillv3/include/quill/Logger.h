...
public:
  ...
  void init_backtrace(uint32_t capacity, LogLevel backtrace_flush_level = LogLevel::None)
  {
    ...
    static constexpr MacroMetadata macro_metadata{
      "", "", "{}", nullptr, LogLevel::Critical, MacroMetadata::Event::InitBacktrace, false, false};
  ...
  void flush_backtrace()
  {
    ...
    static constexpr MacroMetadata macro_metadata{
      "", "", "", nullptr, LogLevel::Critical, MacroMetadata::Event::FlushBacktrace, false, false};
...
private:
  ...
  Logger(std::string const& name,
         ...
         TimestampClock* custom_timestamp_clock,
   ...
   */
  Logger(std::string const& name,
         std::vector<std::shared_ptr<Handler>> const& handlers,
         TimestampClockType timestamp_clock_type,
         TimestampClock* custom_timestamp_clock,
         detail::ThreadContextCollection& thread_context_collection)
