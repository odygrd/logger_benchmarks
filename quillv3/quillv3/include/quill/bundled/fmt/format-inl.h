...
FMTQUILL_FUNC void report_error(format_func func, int error_code, const char* message) noexcept
{
...
template <typename Char>
FMTQUILL_FUNC Char decimal_point_impl(locale_ref)
{
  return '.';
}
#endif
...
template <>
FMTQUILL_API FMTQUILL_FUNC auto format_facet<std::locale>::do_put(appender out,
                                                                  loc_value val,
...
FMTQUILL_FUNC auto vsystem_error(int error_code, string_view fmt, format_args args) -> std::system_error
{
...
{
  FMTQUILL_CONSTEXPR auto parse(format_parse_context& ctx) -> format_parse_context::iterator
  {
    return ctx.begin();
  }
...
FMTQUILL_FUNC void format_system_error(detail::buffer<char>& out, int error_code, const char* message) noexcept
{
  FMTQUILL_TRY
  {
    auto ec = std::error_code(error_code, std::generic_category());
...
FMTQUILL_FUNC void report_system_error(int error_code, const char* message) noexcept
{
...
FMTQUILL_FUNC void vprint(string_view fmt, format_args args) { vprint(stdout, fmt, args); }
