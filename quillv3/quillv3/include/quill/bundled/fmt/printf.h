...
inline auto vsprintf(basic_string_view<Char> fmt,
                     basic_format_args<basic_printf_context<type_identity_t<Char>>> args) -> std::basic_string<Char>
{
...
{
  return vsprintf(detail::to_string_view(fmt), fmtquill::make_format_args<basic_printf_context<Char>>(args...));
}
...
template <typename... T>
FMTQUILL_DEPRECATED inline auto printf(basic_string_view<wchar_t> fmt, const T&... args) -> int
{
