...
inline auto write_ostream_unicode(std::ostream& os, fmtquill::string_view data) -> bool
{
  FILE* f = nullptr;
#if FMTQUILL_MSC_VERSION
...
inline auto write_ostream_unicode(std::wostream&, fmtquill::basic_string_view<wchar_t>) -> bool
{
  return false;
}
