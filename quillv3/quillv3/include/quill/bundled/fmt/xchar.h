...
auto join(Range&& range,
          wstring_view sep) -> join_view<detail::iterator_t<Range>, detail::sentinel_t<Range>, wchar_t>
{
...
template <typename S, typename... T, typename Char = char_t<S>, FMTQUILL_ENABLE_IF(!std::is_same<Char, char>::value && !std::is_same<Char, wchar_t>::value)>
auto format(const S& format_str, T&&... args) -> std::basic_string<Char>
{
  return vformat(detail::to_string_view(format_str), fmtquill::make_format_args<buffer_context<Char>>(args...));
}

template <typename Locale, typename S, typename Char = char_t<S>, FMTQUILL_ENABLE_IF(detail::is_locale<Locale>::value&& detail::is_exotic_char<Char>::value)>
...
template <typename Locale, typename S, typename... T, typename Char = char_t<S>, FMTQUILL_ENABLE_IF(detail::is_locale<Locale>::value&& detail::is_exotic_char<Char>::value)>
...
template <typename OutputIt, typename S, typename Char = char_t<S>, FMTQUILL_ENABLE_IF(detail::is_output_iterator<OutputIt, Char>::value&& detail::is_exotic_char<Char>::value)>
...
template <typename OutputIt,
          ...
          FMTQUILL_ENABLE_IF(detail::is_output_iterator<OutputIt, Char>::value&& detail::is_exotic_char<Char>::value)>
...
template <typename Locale,
          ...
          typename... Args,
          typename Char = char_t<S>,
          FMTQUILL_ENABLE_IF(detail::is_output_iterator<OutputIt, Char>::value&& detail::is_locale<Locale>::value&& detail::is_exotic_char<Char>::value)>
...
template <typename OutputIt, typename Char, typename... Args, FMTQUILL_ENABLE_IF(detail::is_output_iterator<OutputIt, Char>::value&& detail::is_exotic_char<Char>::value)>
...
template <typename S, typename... T, typename Char = char_t<S>, FMTQUILL_ENABLE_IF(detail::is_exotic_char<Char>::value)>
