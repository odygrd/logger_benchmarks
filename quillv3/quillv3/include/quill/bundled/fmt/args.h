...
public:
  ...
  */
  ...
  void push_back(const detail::named_arg<char_type, T>& arg)
  {
    ...
    if (detail::const_check(need_copy<T>::value))
    {
      emplace_arg(fmtquill::arg(arg_name, dynamic_args_.push<stored_type<T>>(arg.value)));
    }
    else
    {
  ...
  */
  ...
  {
    FMTQUILL_ASSERT(new_cap >= new_cap_named, "Set of arguments includes set of named arguments");
