...
extern const int __fmtId__I32have32an32integer3237d__src47testHelper47client46cc__28__ = 0; // src/testHelper/client.cc:28 "I have an integer %d"
extern const int __fmtId__I32have32a32couple32of32things3237d443237f443237u443237s__src47testHelper47client46cc__31__ = 1; // src/testHelper/client.cc:31 "I have a couple of things %d, %f, %u, %s"
extern const int __fmtId__I32have32a32uint6495t3237lu__src47testHelper47client46cc__29__ = 2; // src/testHelper/client.cc:29 "I have a uint64_t %lu"
extern const int __fmtId__Warning32Level__src47testHelper47client46cc__25__ = 3; // src/testHelper/client.cc:25 "Warning Level"
extern const int __fmtId__Simple32log32message32with32032parameters__src47testHelper47client46cc__20__ = 4; // src/testHelper/client.cc:20 "Simple log message with 0 parameters"
extern const int __fmtId__I32have32a32double3237lf__src47testHelper47client46cc__30__ = 5; // src/testHelper/client.cc:30 "I have a double %lf"
extern const int __fmtId__This32is32a32string3237s__src47testHelper47client46cc__21__ = 6; // src/testHelper/client.cc:21 "This is a string %s"
extern const int __fmtId__Error32Level__src47testHelper47client46cc__26__ = 7; // src/testHelper/client.cc:26 "Error Level"
extern const int __fmtId__Notice32Level__src47testHelper47client46cc__24__ = 8; // src/testHelper/client.cc:24 "Notice Level"
extern const int __fmtId__Debug32level__src47testHelper47client46cc__23__ = 9; // src/testHelper/client.cc:23 "Debug level"
