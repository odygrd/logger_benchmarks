...
namespace bq {
    ...
    public:
        ...
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true>
        bool verbose(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true, typename...Args>
        bool verbose(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true>
        bool debug(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true, typename...Args>
        bool debug(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true>
        bool info(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true, typename...Args>
        bool info(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true>
        bool warning(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true, typename...Args>
        bool warning(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true>
        bool error(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true, typename...Args>
        bool error(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true>
        bool fatal(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const;
        template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool> = true, typename...Args>
        bool fatal(const test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const;
    };
    ...
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>>
    inline bool test_category_log::verbose(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::verbose, log_content);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>, typename...Args>
    inline bool test_category_log::verbose(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::verbose, log_format_content, args...);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>>
    inline bool test_category_log::debug(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::debug, log_content);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>, typename...Args>
    inline bool test_category_log::debug(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::debug, log_format_content, args...);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>>
    inline bool test_category_log::info(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::info, log_content);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>, typename...Args>
    inline bool test_category_log::info(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::info, log_format_content, args...);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>>
    inline bool test_category_log::warning(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::warning, log_content);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>, typename...Args>
    inline bool test_category_log::warning(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::warning, log_format_content, args...);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>>
    inline bool test_category_log::error(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::error, log_content);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>, typename...Args>
    inline bool test_category_log::error(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::error, log_format_content, args...);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>>
    inline bool test_category_log::fatal(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_content) const
    {
        (void)category;
        return do_log(CAT_INDEX, log_level::fatal, log_content);
    }
    template<typename STR, uint32_t CAT_INDEX, bq::enable_if_t<bq::test_category_log::is_test_category_log_format_type<STR>::value, bool>, typename...Args>
    inline bool test_category_log::fatal(const test_category_log::test_category_log_category_base<CAT_INDEX>& category, const STR& log_format_content, const Args&... args) const
    {
        (void)category;
