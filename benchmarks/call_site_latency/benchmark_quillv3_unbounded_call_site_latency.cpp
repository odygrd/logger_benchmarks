...
{
  std::remove("benchmark_quillv3_unbounded_call_site_latency.log");
  ...
  std::shared_ptr<quill::Handler> file_handler =
    quill::file_handler("benchmark_quillv3_unbounded_call_site_latency.log",
                        []()
                        {
  ...
  std::string benchmark_name = "Logger: Quill v3 - Benchmark: Caller Thread Latency, Unbounded";
  benchmark_name += " - ";
