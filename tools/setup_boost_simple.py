...
# Libraries built by tools/setup_boost_simple.py using Boost's b2 build system
...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir_str:
        ...
        try:
            ...
            print("\nNext steps:")
            print("1. Configure the project with CMake")
            print("2. Build the benchmark targets")
